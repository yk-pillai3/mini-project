...
<body>
	...
	if (!isset($_GET['page'])) {
		...
		$sql="select uname,pic_path,type from details where type='user' order by uname limit ". $this_page_first_result .",".$results_per_page;
		$result=$mysqli->query($sql);
		...
		for ($page=1; $page<=$no_of_pages ; $page++) { 
			echo "<a href='sort.php?page=" .$page. "'>".$page."</a>";
			echo "&nbsp&nbsp";
		}
		echo "</div>";
	?>
